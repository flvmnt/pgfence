        ...
        results.push({
          ...
          safeRewrite: {
            ...
            steps: [
              ...
              `-- Note: VALIDATE CONSTRAINT may take a long time, but it only requires a SHARE UPDATE EXCLUSIVE lock which allows concurrent reads and writes (SELECT, INSERT, UPDATE, DELETE) but blocks other schema changes.`,
            ],
          },
        });
        break;
