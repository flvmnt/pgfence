...
1. **`ADD COLUMN ... NOT NULL DEFAULT clock_timestamp()`**: `ACCESS EXCLUSIVE` lock for the duration of a full table rewrite. Volatile defaults force a rewrite even on PG11+.
